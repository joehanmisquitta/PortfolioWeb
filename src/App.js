  ...
  return (
    <div className="App">
      ...
      <div className="App-Main">
        ...
        <p className="App-About-Para">I am an aspiring software developer with a particular interest in Cybersecurity, Automation and Photography and I am always looking forward to learn new things.</p>
